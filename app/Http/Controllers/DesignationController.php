...
class DesignationController extends Controller
{
    ...
    public function index()
	{
		...
		$departments = department::select('id', 'department_name')->get();
			...
			if (request()->ajax())
			{
				return datatables()->of(designation::with('department')->get())
			...
			return view('organization.designation.index', compact('departments'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('designation_name', 'department_id'),
				[
	...
	public function update(Request $request)
	{
		...
		if ($logged_user->can('edit-designation'))
		{
			...
			$data = $request->only('designation_name', 'department_id');
