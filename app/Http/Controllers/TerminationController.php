...
class TerminationController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-termination'))
		{
			if (request()->ajax())
			{
				return datatables()->of(Termination::with('employee')->get())
			...
			return view('core_hr.termination.index', compact('employees', 'termination_types'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('description', 'terminated_employee', 'termination_type', 'termination_date', 'notice_date'
			),
				[
	...
	public function edit($id)
	{
		...
		{
			$data = Termination::findOrFail($id);
			$employees = Employee::select('id', 'first_name', 'last_name')->where('id', $data->terminated_employee)->get();
