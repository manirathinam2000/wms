...
class ResignationController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-resignation'))
		{
			if (request()->ajax())
			{
				return datatables()->of(Resignation::with('employee')->get())
			...
			return view('core_hr.resignation.index', compact('employees','departments'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('description', 'department_id', 'employee_id', 'resignation_date', 'notice_date'
			),
				[
