...
class AnnouncementController extends Controller {
	...
	public function index()
	{
		...
		if (request()->ajax())
		{
			...
			else
			{
				...
				$announcements = Announcement::where('department_id',$employee->department_id)
	...
	function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('title', 'start_date', 'end_date', 'summary', 'description', 'is_notify', 'department_id', 'is_active'),
				[
