...
class PromotionController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-promotion'))
		{
			if (request()->ajax())
			{
				return datatables()->of(Promotion::with('employee')->get())
			...
			return view('core_hr.promotion.index', compact('employees'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('employee_id', 'promotion_title', 'description', 'promotion_date'),
				[
