...
class DepartmentController extends Controller {
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('department_name', 'department_head'),
				[
	...
	public function update(Request $request)
	{
		...
		if ($logged_user->can('edit-department'))
		{
			...
			$data = $request->only('department_name', 'department_head');


			$validator = Validator::make($request->only('department_name', 'location_id'),
				[
