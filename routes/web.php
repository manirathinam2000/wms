...
Route::group(['middleware' => ['XSS']], function ()
{
	...
	Route::get('locations/getdata', 'LocationController@get_data')->name('locations.getdata');
	...
	Route::get('employee/getdata', 'EmployeeController@get_data')->name('employee.getdata');
	...
	Route::get('part/getdata', 'PartController@get_data')->name('part.getdata');
	Route::get('part/create', 'PartController@create')->name('part.create');
	Route::post('part/create', 'PartController@store')->name('part.store');
	Route::get('part/edit/{id}', 'PartController@edit')->name('part.edit');
	Route::post('part/update', 'PartController@update')->name('part.update');
	Route::get('part/delete/{id}', 'PartController@delete');
	
	Route::get('inspection', 'InspectionController@index')->name('inspection.index');
	Route::get('inspection/getdata', 'InspectionController@get_data')->name('inspection.getdata');
	Route::get('inspection/create', 'InspectionController@create')->name('inspection.create');
	Route::post('inspection/create', 'InspectionController@store')->name('inspection.store');
	Route::get('inspection/edit/{id}', 'InspectionController@edit')->name('inspection.edit');
	Route::post('inspection/update', 'InspectionController@update')->name('inspection.update');
	Route::get('inspection/delete/{id}', 'InspectionController@delete');
	Route::get('inspection/task/{id}', 'InspectionController@task_add')->name('inspection.task');
	Route::post('inspection/task/create', 'InspectionController@task_store')->name('inspection.task.store');

	Route::get('job_card', 'JobCardController@index')->name('job_card.index');
	Route::get('job_card/getdata', 'JobCardController@get_data')->name('job_card.getdata');
	Route::get('job_card/create', 'JobCardController@create')->name('job_card.create');
	Route::post('job_card/create', 'JobCardController@store')->name('job_card.store');
	Route::get('job_card/edit/{id}', 'JobCardController@edit')->name('job_card.edit');
	Route::post('job_card/update', 'JobCardController@update')->name('job_card.update');
	Route::get('job_card/delete/{id}', 'JobCardController@delete');

	Route::get('task_sheet', 'TaskSheetController@index')->name('task_sheet.index');
	Route::get('task_sheet/getdata', 'TaskSheetController@get_data')->name('task_sheet.getdata');
	Route::get('task_sheet/create', 'TaskSheetController@create')->name('task_sheet.create');
	Route::post('task_sheet/create', 'TaskSheetController@store')->name('task_sheet.store');
	Route::get('task_sheet/edit/{id}', 'TaskSheetController@edit')->name('task_sheet.edit');
	Route::post('task_sheet/update', 'TaskSheetController@update')->name('task_sheet.update');
	Route::get('task_sheet/delete/{id}', 'TaskSheetController@delete');

	Route::get('purchase_order_booking', 'PurchaseOrderBookingController@index')->name('purchase_order_booking.index');
	Route::get('purchase_order_booking/getdata', 'PurchaseOrderBookingController@get_data')->name('purchase_order_booking.getdata');
	Route::get('purchase_order_booking/create', 'PurchaseOrderBookingController@create')->name('purchase_order_booking.create');
	Route::post('purchase_order_booking/create', 'PurchaseOrderBookingController@store')->name('purchase_order_booking.store');
	Route::get('purchase_order_booking/edit/{id}', 'PurchaseOrderBookingController@edit')->name('purchase_order_booking.edit');
	Route::post('purchase_order_booking/update', 'PurchaseOrderBookingController@update')->name('purchase_order_booking.update');
	Route::get('purchase_order_booking/delete/{id}', 'PurchaseOrderBookingController@delete');

	Route::get('inventory', 'InventoryController@index')->name('inventory.index');
	Route::get('inventory/getdata', 'InventoryController@get_data')->name('inventory.getdata');
	Route::get('inventory/create', 'InventoryController@create')->name('inventory.create');
	Route::post('inventory/create', 'InventoryController@store')->name('inventory.store');
	Route::get('inventory/edit', 'InventoryController@edit')->name('inventory.edit');
	...
	Route::get('inventory/transfer', 'InventoryController@transfer_index')->name('inventory.transfer');
	Route::get('inventory/transfer/create', 'InventoryController@transfer_create')->name('inventory.transfer.create');
	Route::post('inventory/transfer/create', 'InventoryController@transfer_store')->name('inventory.transfer.store');
	Route::get('inventory/transfer/products/{id}', 'InventoryController@transfer_products_add')->name('inventory.transfer.products');
	Route::post('inventory/transfer/products/create', 'InventoryController@transfer_product_store')->name('inventory.transfer.products.store');
	Route::get('inventory/transfer/edit/{id}', 'InventoryController@transfer_edit')->name('inventory.transfer.edit');

	Route::get('manufacture', 'ManufactureController@index')->name('manufacture.index');
	Route::get('manufacture/getdata', 'ManufactureController@get_data')->name('manufacture.getdata');
	Route::get('manufacture/create', 'ManufactureController@create')->name('manufacture.create');
	Route::post('manufacture/create', 'ManufactureController@store')->name('manufacture.store');
	Route::get('manufacture/edit/{id}', 'ManufactureController@edit')->name('manufacture.edit');
	Route::post('manufacture/update', 'ManufactureController@update')->name('manufacture.update');
	Route::get('manufacture/delete/{id}', 'ManufactureController@delete');
	Route::post('manufacture/delete/selected', 'ManufactureController@delete_by_selection')->name('mass_delete_location');

	Route::get('alert', 'AlertController@index')->name('alert.index');
	Route::get('alert/getdata', 'AlertController@get_data')->name('alert.getdata');
	Route::get('alert/create', 'AlertController@create')->name('alert.create');
	Route::post('alert/create', 'AlertController@store')->name('alert.store');
	...
	Route::get('alert/delete/{id}', 'AlertController@delete');

	Route::get('task', 'TaskController@index')->name('task.index');
	Route::get('task/getdata', 'TaskController@get_data')->name('task.getdata');
	...
	Route::get('vehicle/getdata', 'VehicleController@get_data')->name('vehicle.getdata');
	Route::get('vehicle/create', 'VehicleController@create')->name('vehicle.create');
	Route::post('vehicle/create', 'VehicleController@store')->name('vehicle.store');
	...
	Route::post('vehicle/delete/selected', 'VehicleController@delete_by_selection')->name('mass_delete_location');

	Route::get('vendors', 'VendorController@index')->name('vendor.index');
	Route::get('vendors/getdata', 'VendorController@get_data')->name('vendor.getdata');
	Route::get('vendors/create', 'VendorController@create')->name('vendor.create');
	Route::post('vendors/create', 'VendorController@store')->name('vendor.store');
	...
	Route::post('vendors/delete/selected', 'VendorController@delete_by_selection')->name('vendor_delete_location');

	Route::get('bay', 'BayController@index')->name('bay.index');
	Route::get('bay/getdata', 'BayController@get_data')->name('bay.getdata');
	Route::get('bay/create', 'BayController@create')->name('bay.create');
	Route::post('bay/create', 'BayController@store')->name('bay.store');
	Route::get('bay/edit/{id}', 'BayController@edit')->name('bay.edit');
	Route::post('bay/update', 'BayController@update')->name('bay.update');
	Route::get('bay/delete/{id}', 'BayController@delete');
	Route::post('bay/delete/selected', 'BayController@delete_by_selection')->name('mass_delete_location');

	Route::get('payment_statusss', 'PaymentStatusController@index')->name('payment_status.index');
	Route::get('payment_status/getdata', 'PaymentStatusController@get_data')->name('payment_status.getdata');
	Route::get('payment_status/create', 'PaymentStatusController@create')->name('payment_status.create');
	Route::post('payment_status/create', 'PaymentStatusController@store')->name('payment_status.store');
	Route::get('payment_status/edit/{id}', 'PaymentStatusController@edit')->name('payment_status.edit');
	Route::post('payment_status/update', 'PaymentStatusController@update')->name('payment_status.update');
	Route::get('payment_status/delete/{id}', 'PaymentStatusController@delete');

	Route::get('service', 'ServiceController@index')->name('service.index');
	Route::get('service/getdata', 'ServiceController@get_data')->name('service.getdata');
	...
	Route::post('service/delete/selected', 'ServiceController@delete_by_selection')->name('mass_delete_location');

	Route::get('vehicle_type', 'VehicleTypeController@index')->name('vehicle_type.index');
	Route::get('vehicle_type/getdata', 'VehicleTypeController@get_data')->name('vehicle_type.getdata');
	Route::get('vehicle_type/create', 'VehicleTypeController@create')->name('vehicle_type.create');
	Route::post('vehicle_type/create', 'VehicleTypeController@store')->name('vehicle_type.store');
	Route::get('vehicle_type/edit/{id}', 'VehicleTypeController@edit')->name('vehicle_type.edit');
	Route::post('vehicle_type/update', 'VehicleTypeController@update')->name('vehicle_type.update');
	Route::get('vehicle_type/delete/{id}', 'VehicleTypeController@delete');
	Route::post('vehicle_type/delete/selected', 'VehicleTypeController@delete_by_selection')->name('mass_delete_location');

	Route::get('vehicle_category', 'VehicleCategoryController@index')->name('vehicle_category.index');
	Route::get('vehicle_category/getdata', 'VehicleCategoryController@get_data')->name('vehicle_category.getdata');
	Route::get('vehicle_category/create', 'VehicleCategoryController@create')->name('vehicle_category.create');
	Route::post('vehicle_category/create', 'VehicleCategoryController@store')->name('vehicle_category.store');
	Route::get('vehicle_category/edit/{id}', 'VehicleCategoryController@edit')->name('vehicle_category.edit');
	Route::post('vehicle_category/update', 'VehicleCategoryController@update')->name('vehicle_category.update');
	Route::get('vehicle_category/delete/{id}', 'VehicleCategoryController@delete');

	Route::get('vehicle_model', 'VehicleModelController@index')->name('vehicle_model.index');
	Route::get('vehicle_model/getdata', 'VehicleModelController@get_data')->name('vehicle_model.getdata');
	Route::get('vehicle_model/create', 'VehicleModelController@create')->name('vehicle_model.create');
	Route::post('vehicle_model/create', 'VehicleModelController@store')->name('vehicle_model.store');
	Route::get('vehicle_model/edit/{id}', 'VehicleModelController@edit')->name('vehicle_model.edit');
	Route::post('vehicle_model/update', 'VehicleModelController@update')->name('vehicle_model.update');
	Route::get('vehicle_model/delete/{id}', 'VehicleModelController@delete');

	Route::get('task_category', 'TaskCategoryController@index')->name('task_category.index');
	Route::get('task_category/getdata', 'TaskCategoryController@get_data')->name('task_category.getdata');
	Route::get('task_category/create', 'TaskCategoryController@create')->name('task_category.create');
	Route::post('task_category/create', 'TaskCategoryController@store')->name('task_category.store');
	Route::get('task_category/edit/{id}', 'TaskCategoryController@edit')->name('task_category.edit');
	Route::post('task_category/update', 'TaskCategoryController@update')->name('task_category.update');
	Route::get('task_category/delete/{id}', 'TaskCategoryController@delete');

	
	Route::get('alert_list', 'AlertListController@index')->name('alert_list.index');
	Route::get('alert_list/getdata', 'AlertListController@get_data')->name('alert_list.getdata');
	Route::get('alert_list/create', 'AlertListController@create')->name('alert_list.create');
	Route::post('alert_list/create', 'AlertListController@store')->name('alert_list.store');
	Route::get('alert_list/edit/{id}', 'AlertListController@edit')->name('alert_list.edit');
	Route::post('alert_list/update', 'AlertListController@update')->name('alert_list.update');
	Route::get('alert_list/delete/{id}', 'AlertListController@delete');

	Route::get('task_list', 'TaskListController@index')->name('task_list.index');
	Route::get('task_list/getdata', 'TaskListController@get_data')->name('task_list.getdata');
	Route::get('task_list/create', 'TaskListController@create')->name('task_list.create');
	Route::post('task_list/create', 'TaskListController@store')->name('task_list.store');
	Route::get('task_list/edit/{id}', 'TaskListController@edit')->name('task_list.edit');
	Route::post('task_list/update', 'TaskListController@update')->name('task_list.update');
	Route::get('task_list/delete/{id}', 'TaskListController@delete');
	Route::post('task_list/delete/selected', 'TaskListController@delete_by_selection')->name('mass_delete_location');

	Route::get('task_type', 'TaskTypeController@index')->name('task_type.index');
	Route::get('task_type/getdata', 'TaskTypeController@get_data')->name('task_type.getdata');
	Route::get('task_type/create', 'TaskTypeController@create')->name('task_type.create');
	Route::post('task_type/create', 'TaskTypeController@store')->name('task_type.store');
	Route::get('task_type/edit/{id}', 'TaskTypeController@edit')->name('task_type.edit');
	Route::post('task_type/update', 'TaskTypeController@update')->name('task_type.update');
	Route::get('task_type/delete/{id}', 'TaskTypeController@delete');
	Route::post('task_type/delete/selected', 'TaskTypeController@delete_by_selection')->name('mass_delete_location');

	Route::get('task_status', 'TaskStatusController@index')->name('task_status.index');
	Route::get('task_status/getdata', 'TaskStatusController@get_data')->name('task_status.getdata');
	Route::get('task_status/create', 'TaskStatusController@create')->name('task_status.create');
	Route::post('task_status/create', 'TaskStatusController@store')->name('task_status.store');
	Route::get('task_status/edit/{id}', 'TaskStatusController@edit')->name('task_status.edit');
	Route::post('task_status/update', 'TaskStatusController@update')->name('task_status.update');
	Route::get('task_status/delete/{id}', 'TaskStatusController@delete');

	Route::get('payment_type', 'PaymentTypeController@index')->name('payment_type.index');
	Route::get('payment_type/getdata', 'PaymentTypeController@get_data')->name('payment_type.getdata');
	Route::get('payment_type/create', 'PaymentTypeController@create')->name('payment_type.create');
	Route::post('payment_type/create', 'PaymentTypeController@store')->name('payment_type.store');
	Route::get('payment_type/edit/{id}', 'PaymentTypeController@edit')->name('payment_type.edit');
	Route::post('payment_type/update', 'PaymentTypeController@update')->name('payment_type.update');
	Route::get('payment_type/delete/{id}', 'PaymentTypeController@delete');
	Route::post('payment_type/delete/selected', 'PaymentTypeController@delete_by_selection')->name('mass_delete_location');

	Route::get('employee_category', 'EmployeeCategoryController@index')->name('employee_category.index');
	Route::get('employee_category/getdata', 'EmployeeCategoryController@get_data')->name('employee_category.getdata');
	Route::get('employee_category/create', 'EmployeeCategoryController@create')->name('employee_category.create');
	Route::post('employee_category/create', 'EmployeeCategoryController@store')->name('employee_category.store');
	Route::get('employee_category/edit/{id}', 'EmployeeCategoryController@edit')->name('employee_category.edit');
	Route::post('employee_category/update', 'EmployeeCategoryController@update')->name('employee_category.update');
	Route::get('employee_category/delete/{id}', 'EmployeeCategoryController@delete');


	Route::get('part_type', 'PartTypeController@index')->name('part_type.index');
	Route::get('part_type/getdata', 'PartTypeController@get_data')->name('part_type.getdata');
	Route::get('part_type/create', 'PartTypeController@create')->name('part_type.create');
	Route::post('part_type/create', 'PartTypeController@store')->name('part_type.store');
	Route::get('part_type/edit/{id}', 'PartTypeController@edit')->name('part_type.edit');
	Route::post('part_type/update', 'PartTypeController@update')->name('part_type.update');
	Route::get('part_type/delete/{id}', 'PartTypeController@delete');

	Route::get('part_category', 'PartCategoryController@index')->name('part_category.index');
	Route::get('part_category/getdata', 'PartCategoryController@get_data')->name('part_category.getdata');
	Route::get('part_category/create', 'PartCategoryController@create')->name('part_category.create');
	Route::post('part_category/create', 'PartCategoryController@store')->name('part_category.store');
	Route::get('part_category/edit/{id}', 'PartCategoryController@edit')->name('part_category.edit');
	Route::post('part_category/update', 'PartCategoryController@update')->name('part_category.update');
	Route::get('part_category/delete/{id}', 'PartCategoryController@delete');

	Route::get('uom', 'UOMController@index')->name('uom.index');
	Route::get('uom/getdata', 'UOMController@get_data')->name('uom.getdata');
	Route::get('uom/create', 'UOMController@create')->name('uom.create');
	Route::post('uom/create', 'UOMController@store')->name('uom.store');
	Route::get('uom/edit/{id}', 'UOMController@edit')->name('uom.edit');
	Route::post('uom/update', 'UOMController@update')->name('uom.update');
	Route::get('uom/delete/{id}', 'UOMController@delete');

	Route::get('vendor_category', 'VendorCategoryController@index')->name('vendor_category.index');
	Route::get('vendor_category/getdata', 'VendorCategoryController@get_data')->name('vendor_category.getdata');
	Route::get('vendor_category/create', 'VendorCategoryController@create')->name('vendor_category.create');
	Route::post('vendor_category/create', 'VendorCategoryController@store')->name('vendor_category.store');
	Route::get('vendor_category/edit/{id}', 'VendorCategoryController@edit')->name('vendor_category.edit');
	Route::post('vendor_category/update', 'VendorCategoryController@update')->name('vendor_category.update');
	Route::get('vendor_category/delete/{id}', 'VendorCategoryController@delete');
	Route::post('vendor_category/delete/selected', 'VendorCategoryController@delete_by_selection')->name('mass_delete_location');

	Route::get('service_category', 'ServiceCategoryController@index')->name('service_category.index');
	Route::get('service_category/getdata', 'ServiceCategoryController@get_data')->name('service_category.getdata');
	Route::get('service_category/create', 'ServiceCategoryController@create')->name('service_category.create');
	Route::post('service_category/create', 'ServiceCategoryController@store')->name('service_category.store');
	Route::get('service_category/edit/{id}', 'ServiceCategoryController@edit')->name('service_category.edit');
	Route::post('service_category/update', 'ServiceCategoryController@update')->name('service_category.update');
	Route::get('service_category/delete/{id}', 'ServiceCategoryController@delete');
	Route::post('service_category/delete/selected', 'ServiceCategoryController@delete_by_selection')->name('mass_delete_location');

	Route::get('fuel_card', 'FuelCardController@index')->name('fuel_card.index');
	Route::get('fuel_card/getdata', 'FuelCardController@get_data')->name('fuel_card.getdata');
	Route::get('fuel_card/create', 'FuelCardController@create')->name('fuel_card.create');
	Route::post('fuel_card/create', 'FuelCardController@store')->name('fuel_card.store');
	Route::get('fuel_card/edit/{id}', 'FuelCardController@edit')->name('fuel_card.edit');
	Route::post('fuel_card/update', 'FuelCardController@update')->name('fuel_card.update');
	Route::get('fuel_card/delete/{id}', 'FuelCardController@delete');
	Route::post('fuel_card/delete/selected', 'FuelCardController@delete_by_selection')->name('mass_delete_location');
