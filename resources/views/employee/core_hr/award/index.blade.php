<div class="row">
    <div class="col-md-3">
            ...
            <li class="nav-item">
                    <a class="nav-link active" href="#Employee_ticket" id="employee_ticket-tab"
                       data-toggle="tab" data-table="employee_ticket" data-target="#Employee_ticket" role="tab"
                       aria-controls="Employee_ticket" aria-selected="true">{{trans('file.Ticket')}}</a>
                </li>
    ...
    <div class="col-md-9">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="Employee_ticket" role="tabpanel" aria-labelledby="Employee_ticket-tab">
                {{__('Ticket Info')}}
                <hr>
