...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="{{ route('task_type.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
            <div class="block">
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="task_type_name" name="task_type_name" placeholder="Enter a Type Name.." value="{{ old('task_type_name') }}">
                    </div>
