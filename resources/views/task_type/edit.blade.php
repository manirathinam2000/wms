...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="{{ route('task_type.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
            <input type="hidden" class="form-control" id="hidden_id" name="hidden_id" value="{{ $data->id }}">
            <div class="block">
              <div class="block-header block-header-default">
                <a class="btn btn-alt-secondary" href="{{ route('task_type.index') }}">
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="task_type_name" name="task_type_name" placeholder="Enter a Type Name.." value="{{ $data->task_type_name }}">
                    </div>
