            ...
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-simple" id="location-table">
                ...
                @foreach($data as $rows)
                    <tr>
                        <td>{{ $rows->alert_list_name }}</td>
                        <td>{{ $rows->alert_schedule }}</td>
                        <td>{{ $rows->alert_start_date }}</td>
                        <td>
                          <a type="button" name="edit" href="{{ route('alert.edit', ['id' => $rows->id]) }}" class="edit btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                      </td>
                    </tr>
                @endforeach
                </tbody>
