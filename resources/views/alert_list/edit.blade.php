...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="{{ route('alert_list.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="alert_list_name" name="alert_list_name" placeholder="Enter a Type Name.." value="{{ $data->alert_list_name }}">
                    </div>
