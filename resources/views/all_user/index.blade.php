                        ...
                        <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="first_name" id="first_name" placeholder="{{__('Name')}}"
                                ...
                                <div class="col-md-6 form-group">
                                    <br><br>
                                        ...
                                        <div class="col-md-12 custom-checkbox p-0">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" id="form_edit" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>{{__('Name')}} *</label>
                                    <input type="text" name="first_name" id="first_name_edit" placeholder="{{__('Name')}}"
                                           required class="form-control">
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <br><br>
                                    <div class="col-sm-12 form-group p-0 custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="is_active"
