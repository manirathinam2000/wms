                ...
                <div class="row justify-content-center push">
                  ...
                  <div class="mb-4">
                      ...
                      <select class="form-select" id="task_category_id" name="task_category_id">
                        ...
                        @php
                            $selected = '';
                            if($category->id == $data->task_category_id)
                            $selected = 'selected'
                          @endphp
                        <option value="{{ $category->id }}" {{ $selected }}>{{ $category->task_category_name }}</option>
                        @endforeach
                      </select>
                    </div>                    
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="task_type_id" name="task_type_id">
                        ...
                        @php
                            $selected = '';
                            if($type->id == $data->task_type_id)
                            $selected = 'selected'
                          @endphp
                        <option value="{{ $type->id }}" {{ $selected }}>{{ $type->task_type_name }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="task_list_id" name="task_list_id">
                        ...
                        @php
                            $selected = '';
                            if($list->id == $data->task_list_id)
                            $selected = 'selected'
                          @endphp
                        <option value="{{ $list->id }}" {{ $selected }}>{{ $list->task_list_name }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="day_of_service">Day of Service</label>
                      <input type="text" class="form-control" id="day_of_service" name="day_of_service" placeholder="Enter Day of Service.." value="{{ $data->day_of_service }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="km_of_service">KM of Service</label>
                      <input type="text" class="form-control" id="km_of_service" name="km_of_service" placeholder="Enter KM of Service.." value="{{ $data->km_of_service }}">
                    </div>
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="status_id" name="status_id">
                        ...
                        @php
                            ...
                            $selected = 'selected'
                          @endphp
                        <option value="{{ $status->id }}" {{ $selected }}>{{ $status->task_status_name }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="mb-4">
                    @php
                            ...
                            if($data->auto_update == 1)
                              $checked = 'checked'
                          @endphp
                      <input class="form-check-input" type="checkbox" value="1" id="auto_update" name="auto_update" {{ $checked }}>
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="standard_time" name="standard_time" placeholder="Enter a Standard Time.." value="{{ $data->standard_time }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="rate_per_hour">Rate Per Hour</label>
                      <input type="text" class="form-control" id="rate_per_hour" name="rate_per_hour" placeholder="Enter a Rate Per Hour.." value="{{ $data->rate_per_hour }}">
                    </div>
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        <label class="form-label" for="sub_task_01">Sub Task - 01</label>
                        <input type="text" class="form-control" id="sub_task_01" name="sub_task_01" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_01 }}" >
                      </div>
                      <div class="col-md-5">
                        ...
                        <select class="form-select" id="spare_part_01" name="spare_part_01">
                          ...
                          @php
                            $selected = '';
                            if($part->id == $data->spare_part_01)
                            $selected = 'selected'
                          @endphp
                          <option value="{{ $part->id }}" {{ $selected }}>{{ $part->part_name }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_02" name="sub_task_02" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_02 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_03" name="sub_task_03" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_03 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_04" name="sub_task_04" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_04 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_05" name="sub_task_05" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_05 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_06" name="sub_task_06" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_06 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_07" name="sub_task_07" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_07 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_08" name="sub_task_08" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_08 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_09" name="sub_task_09" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_09 }}" >
                      </div>
                      <div class="col-md-5">
                    ...
                    <div class="mb-4 d-flex justify-content-between">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="sub_task_10" name="sub_task_10" placeholder="Enter a Sub Task.." value="{{ $data->sub_task_10 }}" >
                      </div>
                      <div class="col-md-5">
