            ...
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-simple" id="location-table">
                ...
                @foreach($data as $rows)
                    <tr>
                        <td>{{ $rows->manufacture_name }}</td>
                        <td>{{ $rows->sap_ref_code }}</td>
                        <td>{{ $rows->contact_person}}</td>
                        <td>{{ $rows->email}}</td>
                        <td>
                          <a type="button" name="edit" href="{{ route('manufacture.edit', ['id' => $rows->id]) }}" class="edit btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
