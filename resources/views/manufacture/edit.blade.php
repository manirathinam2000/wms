...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="{{ route('manufacture.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="manufacture_name" name="manufacture_name" placeholder="Enter Manufacture Name.." value="{{ $data->manufacture_name }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="sap_ref_code">SAP Ref Code</label>
                      <input type="text" class="form-control" id="sap_ref_code" name="sap_ref_code" placeholder="Enter SAP Ref Code.." value="{{ $data->sap_ref_code }}">
                    </div>
                    <div class="mb-4">
