                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="service_category_name" name="service_category_name" placeholder="Enter a Service Category.." value="{{ old('service_category_name') }}">
                    </div>
