                    ...
                    <div class="modal-body">
                        ...
                        <form method="get" id="payment_form" class="form-horizontal" >
                               ...
                               <div class="row">
                                ...
                                <div class="col-md-12 hide-element">
                                    <div class="form-group">
                            ...
                            <div class="form-actions col-md-12"> <button  type="submit" class="btn btn-primary"><i class="fa fa fa-check-square-o"></i> {{trans('file.Pay')}}</button>
                            </div>
                               </div>
                        </form>
                    </div>
