                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="vehicle_registration_number" name="vehicle_registration_number" placeholder="Enter Vehicle Registration Number.." value="{{ old('vehicle_registration_number') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="sufix">Sufix</label>
                      <input type="text" class="form-control" id="sufix" name="sufix" placeholder="Enter Sufix.." value="{{ old('sufix') }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="vin" name="vin" placeholder="Enter a VIN.." value="{{ old('vin') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="engine_no">Engine Number</label>
                      <input type="text" class="form-control" id="engine_no" name="engine_no" placeholder="Enter a Engine Number.." value="{{ old('engine_no') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="engine">Engine</label>
                      <input type="text" class="form-control" id="engine" name="engine" placeholder="Enter a Engine.." value="{{ old('engine') }}" >
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="color">Color</label>
                      <input type="text" class="form-control" id="color" name="color" placeholder="Enter a Color.." value="{{ old('color') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="trims">Trim</label>
                      <input type="text" class="form-control" id="trims" name="trims" placeholder="Enter a Trim.." value="{{ old('trims') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="std_fitment">STD Fitment</label>
                      <input type="text" class="form-control" id="std_fitment" name="std_fitment" placeholder="Enter STD Fitment.." value="{{ old('std_fitment') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="reg_type">Reg Type</label>
                      <input type="text" class="form-control" id="reg_type" name="reg_type" placeholder="Enter Reg Type.." value="{{ old('reg_type') }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="key_no" name="key_no" placeholder="Enter Key Number.." value="{{ old('key_no') }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="owner_name" name="owner_name" placeholder="Enter Owner Name.." value="{{ old('owner_name') }}">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="amc_status" name="amc_status" placeholder="Enter AMC Status.." value="{{ old('amc_status') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="registration_expiry">Registration Expiry</label>
                      <input type="text" class="form-control" id="registration_expiry" name="registration_expiry" placeholder="Enter Registration Expiry.." value="{{ old('registration_expiry') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="insurance_policy_number">Insurance Policy Number</label>
                      <input type="text" class="form-control" id="insurance_policy_number" name="insurance_policy_number" placeholder="Enter Insurance Policy Number.." value="{{ old('insurance_policy_number') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="premium_amount">Premium Amount</label>
                      <input type="text" class="form-control" id="premium_amount" name="premium_amount" placeholder="Enter Premium Amount.." value="{{ old('premium_amount') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="insurance_expiry">Insurance Expiry</label>
                      <input type="text" class="form-control" id="insurance_expiry" name="insurance_expiry" placeholder="Enter Insurance Expiry.." value="{{ old('insurance_expiry') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="purchase_date">Purchase Date</label>
                      <input type="text" class="form-control" id="purchase_date" name="purchase_date" placeholder="Enter Purchase Date.." value="{{ old('purchase_date') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="purchase_cost">Purchase Cost</label>
                      <input type="text" class="form-control" id="purchase_cost" name="purchase_cost" placeholder="Enter Purchase Cost.." value="{{ old('purchase_cost') }}">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="asset_structure">Asset Structure</label>
                      <input type="text" class="form-control" id="asset_structure" name="asset_structure" placeholder="Enter Asset Structure.." value="{{ old('asset_structure') }}">
                    </div>
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="fuel_card_number_id" name="fuel_card_number_id">
                        ...
                        <option value="{{ $card->id }}">{{ $card->fuel_card_number }}</option>
                        @endforeach
                      </select>
                    </div>                    
                    <div class="mb-4">
