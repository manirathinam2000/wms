...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="{{ route('payment_status.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="payment_status_name" name="payment_status_name" placeholder="Enter a Type Name.." value="{{ $data->payment_status_name }}">
                    </div>
