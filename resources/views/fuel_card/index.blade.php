            ...
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-simple" id="location-table">
                ...
                @foreach($data as $rows)
                    <tr>
                        <td>{{ $rows->fuel_card_number }}</td>
                        <td>{{ $rows->fuel_card_company }}</td>
                        <td>{{ $rows->limits }}</td>
                        <td>{{ $rows->expiry }}</td>
                        <td>
                          <a type="button" name="edit" href="{{ route('fuel_card.edit', ['id' => $rows->id]) }}" class="edit btn btn-primary btn-sm"><i class="far fa-edit"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
