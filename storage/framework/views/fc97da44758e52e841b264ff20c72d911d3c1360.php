...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="<?php echo e(route('bay.store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            <div class="block">
              <div class="block-header block-header-default">
                <a class="btn btn-alt-secondary" href="<?php echo e(route('bay.index')); ?>">
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="bay_name" name="bay_name" placeholder="Enter a bay name.." value="<?php echo e(old('bay_name')); ?>">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="task_type_id" name="task_type_id">
                        ...
                        <option value="<?php echo e($task_type->id); ?>"><?php echo e($task_type->task_type_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                  </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vegkuxyk/kalaashcharya.in/demo/wms/resources/views/bay/create.blade.php ENDPATH**/ ?>