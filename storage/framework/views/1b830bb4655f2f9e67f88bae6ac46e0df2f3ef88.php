...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="<?php echo e(route('vendor.update')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-10">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="vendor_name" name="vendor_name" placeholder="Enter vendor Name.." value="<?php echo e($data->vendor_name); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="ref_code">Ref Code</label>
                      <input type="text" class="form-control" id="ref_code" name="ref_code" placeholder="Enter Ref Code.." value="<?php echo e($data->ref_code); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="cr_number">Ref Code</label>
                      <input type="text" class="form-control" id="cr_number" name="cr_number" placeholder="Enter CR Number.." value="<?php echo e($data->cr_number); ?>">
                    </div>
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="category_id" name="category_id">
                        ...
                        <?php
                            ...
                            $selected = 'selected'
                          ?>
                        <option value="<?php echo e($category->id); ?>" <?php echo e($selected); ?>><?php echo e($category->vendor_category_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="tax_number">Tax Number</label>
                      <input type="text" class="form-control" id="tax_number" name="tax_number" placeholder="Enter Tax Number.." value="<?php echo e($data->tax_number); ?>">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" id="debtor_in_charge" name="debtor_in_charge" placeholder="Enter a Debtor In Charge.." value="<?php echo e($data->debtor_in_charge); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="currency">Currency</label>
                      <input type="text" class="form-control" id="currency" name="currency" placeholder="Enter Currency.." value="<?php echo e($data->currency); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="credit_amount">Credit Amount</label>
                      <input type="text" class="form-control" id="credit_amount" name="credit_amount" placeholder="Enter Credit Amount.." value="<?php echo e($data->credit_amount); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="credit_days">Credit Days</label>
                      <input type="text" class="form-control" id="credit_days" name="credit_days" placeholder="Enter Credit Days.." value="<?php echo e($data->credit_days); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="opening_balance">Opening Balance</label>
                      <input type="text" class="form-control" id="opening_balance" name="opening_balance" placeholder="Enter Opening Balance.." value="<?php echo e($data->opening_balance); ?>">
                    </div>
                    <div class="mb-4">
                      ...
                      <select class="form-select" id="payment_type_id" name="payment_type_id">
                        ...
                        <?php
                            ...
                            $selected = 'selected'
                          ?>
                        <option value="<?php echo e($payment_type->id); ?>" <?php echo e($selected); ?>><?php echo e($payment_type->payment_type_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="remarks">Remarks</label>
                      <textarea class="form-control" id="remarks" name="remarks" rows="4" placeholder="Remarks.."><?php echo e($data->remarks); ?></textarea>
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="column1">Column 1</label>
                      <input type="text" class="form-control" id="column1" name="column1" placeholder="Enter a value.." value="<?php echo e($data->column1); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="column2">Column 2</label>
                      <input type="text" class="form-control" id="column2" name="column2" placeholder="Enter a value.." value="<?php echo e($data->column2); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="column3">Column 3</label>
                      <input type="text" class="form-control" id="column3" name="column3" placeholder="Enter a value.." value="<?php echo e($data->column3); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="column4">Column 4</label>
                      <input type="text" class="form-control" id="column4" name="column4" placeholder="Enter a value.." value="<?php echo e($data->column4); ?>">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="column5">Column 5</label>
                      <input type="text" class="form-control" id="column5" name="column5" placeholder="Enter a value.." value="<?php echo e($data->column5); ?>">
                    </div>                    
                  </div>
                </div>
              </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vegkuxyk/kalaashcharya.in/demo/wms/resources/views/vendor/edit.blade.php ENDPATH**/ ?>