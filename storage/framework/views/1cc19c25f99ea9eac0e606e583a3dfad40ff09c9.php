...
<!-- Hero -->
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="<?php echo e(route('inspection.store')); ?>" method="POST" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            <div class="block">
                ...
                <div class="row justify-content-center push">
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      ...
                      <input type="text" class="form-control" id="id" name="id" placeholder="Inspection No. will be auto generated" value="<?php echo e(old('id')); ?>" disabled>
                    </div>
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="ref_no">Reference No.</label>
                      <input type="text" class="form-control" id="ref_no" name="ref_no" placeholder="Enter Reference No.." value="<?php echo e(old('ref_no')); ?>">
                    </div>
                  </div>
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="date_time">Date &amp; Time</label>
                      <input type="text" class="form-control" id="date_time" name="date_time" placeholder="Enter Date &amp; Time.." value="<?php echo e(old('date_time')); ?>">
                    </div>
                    <div class="col-md-5 ms-5">
                    <label class="form-label" for="service_category_id">Service Type</label>
                      <select class="form-select" id="service_category_id" name="service_category_id">
                        ...
                        <option value="<?php echo e($category->id); ?>"><?php echo e($category->service_category_name); ?></option>
                  ...
                  <div class="col-md-12 d-flex mb-3">
                    ...
                    <div class="col-md-5 ms-5">
                      ...
                      <input type="text" class="form-control" id="vehicle_registration_number" name="vehicle_registration_number" placeholder="Customer Reg No" value="<?php echo e(old('id')); ?>" disabled>
                    </div>                    
                  </div>
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="email">Email</label>
                      <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo e(old('id')); ?>" disabled>
                    </div> 
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="vin">VIN</label>
                      <input type="text" class="form-control" id="vin" name="vin" placeholder="VIN" value="<?php echo e(old('id')); ?>" disabled>
                    </div>                    
                  </div>
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="phone">Phone</label>
                      <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone" value="<?php echo e(old('id')); ?>" disabled>
                    </div>      
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="Make">Make</label>
                      <input type="text" class="form-control" id="Make" name="Make" placeholder="Make" value="<?php echo e(old('id')); ?>" disabled>
                    </div>               
                  </div>
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="mileage">Mileage</label>
                      <input type="text" class="form-control" id="mileage" name="mileage" placeholder="Enter Mileage" value="<?php echo e(old('id')); ?>">
                    </div>      
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="model">Model</label>
                      <input type="text" class="form-control" id="model" name="model" placeholder="Model" value="<?php echo e(old('id')); ?>" disabled>
                    </div>               
                  </div>
                  <div class="col-md-12 d-flex mb-3">
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="odometer">Odometer</label>
                      <input type="text" class="form-control" id="odometer" name="odometer" placeholder="Enter Odometer" value="<?php echo e(old('id')); ?>">
                    </div>      
                    <div class="col-md-5 ms-5">
                      <label class="form-label" for="fuel">Fuel</label>
                      <input type="text" class="form-control" id="fuel" name="fuel" placeholder="Enter Fuel" value="<?php echo e(old('id')); ?>">
                    </div>               
                  </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vegkuxyk/kalaashcharya.in/demo/wms/resources/views/inspection/create.blade.php ENDPATH**/ ?>