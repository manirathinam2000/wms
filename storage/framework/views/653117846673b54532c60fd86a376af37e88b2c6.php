...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" id="css-main" href="<?php echo e(asset('assets/css/dashmix.css')); ?>">

    <!-- You can include a specific file from css/themes/ folder to alter the default color theme of the template. eg: -->
    <!-- <link rel="stylesheet" id="css-theme" href="<?php echo e(asset('assets/css/themes/xwork.min.css')); ?>"> -->
    <!-- END Stylesheets -->
  </head>
  <body>
    <!-- Page Container -->
          ...
          <div class="bg-primary-op">
            <div class="content-header">
              ...
              <a class="img-link me-1" href="be_pages_generic_profile.html">
                <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar10.jpg')); ?>" alt="">
              </a>
              <!-- END User Avatar -->
                ...
                <div class="block mb-0">
                  ...
                  <div class="block-content block-content-full">
                    <div class="row g-sm text-center">
                      ...
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xwork" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xwork.min.css')); ?>" href="#">
                          xWork
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xmodern" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xmodern.min.css')); ?>" href="#">
                          xModern
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xeco" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xeco.min.css')); ?>" href="#">
                          xEco
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xsmooth" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xsmooth.min.css')); ?>" href="#">
                          xSmooth
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xinspire" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xinspire.min.css')); ?>" href="#">
                          xInspire
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xdream" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xdream.min.css')); ?>" href="#">
                          xDream
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xpro" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xpro.min.css')); ?>" href="#">
                          xPro
                        </a>
                      </div>
                      <div class="col-4 mb-1">
                        <a class="d-block py-3 text-white fs-sm fw-semibold bg-xplay" data-toggle="theme" data-theme="<?php echo e(asset('assets/css/themes/xplay.min.css')); ?>" href="#">
                          xPlay
                        </a>
                      </div>
                      <div class="col-12">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar4.jpg')); ?>" alt="">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar11.jpg')); ?>" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar5.jpg')); ?>" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-success"></span>
                          </div>
                          <div class="flex-grow-1">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar7.jpg')); ?>" alt="">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar14.jpg')); ?>" alt="">
                  ...
                  <div class="block-content">
                    <ul class="nav-items">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar3.jpg')); ?>" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                          </div>
                          <div class="flex-grow-1">
                      ...
                      <li>
                        <a class="d-flex py-2" href="be_pages_generic_profile.html">
                          <div class="flex-shrink-0 mx-3 overlay-container">
                            <img class="img-avatar img-avatar48" src="<?php echo e(asset('assets/media/avatars/avatar15.jpg')); ?>" alt="">
                            <span class="overlay-item item item-tiny item-circle border border-2 border-white bg-muted"></span>
                          </div>
                          <div class="flex-grow-1">
          ...
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="index.html">
              ...
              <span class="smini-hidden">
                <span class="opacity-75">MST</span>
              </span>
            </a>
            <!-- END Logo -->
          ...
          <div class="content-side">
            <ul class="nav-main">
              <li class="nav-main-item">
                <a class="nav-main-link active" href="<?php echo e(url('admin/dashboard')); ?>">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('task_type.index')); ?>">
                      <span class="nav-main-link-name">Task Type</span>
                    </a>
                  </li>
                  
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('payment_type.index')); ?>">
                      <span class="nav-main-link-name">Payment Type</span>
                    </a>
                  </li>
          
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('uom.index')); ?>">
                      <span class="nav-main-link-name">UOM</span>
                    </a>
                  </li>

                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('payment_status.index')); ?>">
                      <span class="nav-main-link-name">Payment Status</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('service.index')); ?>">
                      <span class="nav-main-link-name">Service</span>
                    </a>
                  </li>
                  
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('service_category.index')); ?>">
                      <span class="nav-main-link-name">Service Category</span>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  <i class="nav-main-link-icon fa fa-screwdriver"></i>
                  <span class="nav-main-link-name">Parts</span>
                </a>
                <ul class="nav-main-submenu">

                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('part.index')); ?>">
                      <span class="nav-main-link-name">Parts</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('part_category.index')); ?>">
                      <span class="nav-main-link-name">Part Category</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('part_type.index')); ?>">
                      <span class="nav-main-link-name">Part Type</span>
                    </a>
                  </li>
              ...
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  <i class="nav-main-link-icon fa fa-truck-monster"></i>
                  <span class="nav-main-link-name">Vehicle </span>
                </a>
                <ul class="nav-main-submenu">

                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vehicle.index')); ?>">
                      <span class="nav-main-link-name">Vehicle</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vehicle_model.index')); ?>">
                      <span class="nav-main-link-name">Model</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vehicle_type.index')); ?>">
                      <span class="nav-main-link-name">Vehicle Type</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vehicle_category.index')); ?>">
                      <span class="nav-main-link-name">Vehicle Category</span>
                    </a>
                  </li>
              ...
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  ...
                  <span class="nav-main-link-name">Task</span>
                </a>
                <ul class="nav-main-submenu">

                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('task.index')); ?>">
                      <span class="nav-main-link-name">Task</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('task_list.index')); ?>">
                      <span class="nav-main-link-name">Task List</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('task_status.index')); ?>">
                      <span class="nav-main-link-name">Task Status</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('task_category.index')); ?>">
                      <span class="nav-main-link-name">Task Category</span>
                    </a>
                  </li>
              ...
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  ...
                  <span class="nav-main-link-name">Statutory Alert</span>
                </a>
                <ul class="nav-main-submenu">

                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('alert.index')); ?>">
                      <span class="nav-main-link-name">Alerts</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('alert_list.index')); ?>">
                      <span class="nav-main-link-name">Alert List</span>
                    </a>
                  </li>                  
                </ul>
              </li>
              <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('locations.index')); ?>">
              ...
              <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('bay.index')); ?>">
                    <i class="nav-main-link-icon fa fa-bars"></i>
                      <span class="nav-main-link-name">Bay</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('fuel_card.index')); ?>">
                    <i class="nav-main-link-icon fa fa-credit-card"></i>
                      <span class="nav-main-link-name">Fuel Card</span>
                    </a>
                  </li>
              <li class="nav-main-heading">Contacts</li>
              <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('manufacture.index')); ?>">
                    <i class="nav-main-link-icon fa fa-users-cog"></i>
                      <span class="nav-main-link-name">Manufacture</span>
                    </a>
                  </li>
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vendor.index')); ?>">
                      <span class="nav-main-link-name">Vendor</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('vendor_category.index')); ?>">
                      <span class="nav-main-link-name">Vendor Category</span>
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('employee.index')); ?>">
                      <span class="nav-main-link-name">Supervisor/Mechanic </span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('employee_category.index')); ?>">
                      <span class="nav-main-link-name">Employee Category</span>
                    </a>
                  </li>
                </ul>
              </li>
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('inventory.index')); ?>">
                    <i class="nav-main-link-icon fa fa-warehouse"></i>
                      <span class="nav-main-link-name">Stocks</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('purchase_order_booking.index')); ?>">
                    <i class="nav-main-link-icon fa fa-mail-bulk"></i>
                      <span class="nav-main-link-name">Purchase Order</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('inventory.create')); ?>">
                    <i class="nav-main-link-icon fa fa-truck-moving"></i>
                      <span class="nav-main-link-name">Goods Inward</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('inventory.edit')); ?>">
                    <i class="nav-main-link-icon fa fa-truck-loading"></i>
                      <span class="nav-main-link-name">Goods Return</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('inventory.transfer')); ?>">
                    <i class="nav-main-link-icon fa fa-people-carry"></i>
                      <span class="nav-main-link-name">Move Goods</span>
                    </a>
                  </li>
                  <li class="nav-main-heading">Job Card Management</li>
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="<?php echo e(route('inspection.index')); ?>">
                    <i class="nav-main-link-icon fa fa-tasks"></i>
                      <span class="nav-main-link-name">Inspection</span>
                    </a>
                    <a class="nav-main-link" href="<?php echo e(route('job_card.index')); ?>">
                    <i class="nav-main-link-icon fa fa-list-alt"></i>
                      <span class="nav-main-link-name">Job Card</span>
                    </a>
                    <a class="nav-main-link" href="<?php echo e(route('task_sheet.index')); ?>">
                    <i class="nav-main-link-icon fa fa-th-list"></i>
                      <span class="nav-main-link-name">Task Sheet</span>
                    </a>
                  </li>
                </ul>
              </li>
      ...
      <header id="page-header">
        ...
        <div class="content-header">
          ...
          <div class="space-x-1">
              ...
              <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                ...
                <div class="p-2">
                  ...
                  <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button class="btn" type="submit"><i class="far fa-fw fa-arrow-alt-circle-left me-1"></i> Sign Out</button>
                                </form>
            ...
            <button type="button" class="btn btn-alt-secondary" data-toggle="layout" data-action="">
        ...
        <div id="page-header-search" class="overlay-header bg-header-dark">
          <div class="bg-white-10">
            <div class="content-header">
              <form class="w-100" action="be_pages_generic_search.html" method="POST" onsubmit="return false;">
        ...
        <div class="content py-0">
          <div class="row fs-sm">
            <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
              Developed by <a class="fw-semibold" href="#" target="_blank">Tech D Solution</a>
            </div>
            <div class="col-sm-6 order-sm-1 text-center text-sm-start">
              <a class="fw-semibold" href="#">MST</a> &copy; <span data-toggle="year-copy"><?php echo date('Y'); ?></span>
            </div>
          </div>
        </div>
      </footer>
...
<?php /**PATH /home/vegkuxyk/kalaashcharya.in/demo/wms/resources/views/layout/main.blade.php ENDPATH**/ ?>