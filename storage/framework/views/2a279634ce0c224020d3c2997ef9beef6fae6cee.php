<?php $__env->startSection('content'); ?>
        ...
        <!-- Page Content -->
        <div class="content">
          <div class="col-md-12 text-center my-7">
          <h3>We are working on the Features!!</h3>
          <div>
          <!-- Overview -->
...
<!-- Page JS Plugins -->
<script src="<?php echo e(asset('assets/js/plugins/chart.js/chart.min.js')); ?>"></script>

<!-- Page JS Code -->
<script src="<?php echo e(asset('assets/js/pages/be_pages_dashboard.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vegkuxyk/kalaashcharya.in/demo/wms/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>